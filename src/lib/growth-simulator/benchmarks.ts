...
export const FUNNEL_STAGE_BENCHMARKS: BenchmarkMetric[] = [
  ...
  // -- App: first open, in-app purchase --------------------------------------
  {
    ...
    bestInClass: 90,
    tier: 3,
    source: "AppsFlyer/Adjust India app onboarding benchmarks (install-to-first-session)",
    sourceDate: "2025-04-01",
    lastVerified: "2026-02-01",
    confidenceScore: 55,
  ...
  },
  {
    ...
    bestInClass: 22,
    tier: 5,
    source: "Strategy-desk aggregated benchmark across past India app-monetization engagements — triangulated against AppsFlyer/Adjust India app-revenue reports",
    sourceDate: "2025-06-01",
    lastVerified: "2026-02-01",
    confidenceScore: 35,
    applicabilityScore: 60,
  ...
  },
  {
    ...
    bestInClass: 40,
    tier: 5,
    source: "Strategy-desk aggregated benchmark across past India app-reactivation engagements — triangulated against Adjust/AppsFlyer re-engagement campaign benchmark commentary",
    sourceDate: "2025-06-01",
    lastVerified: "2026-02-01",
    confidenceScore: 34,
    applicabilityScore: 62,
...
const appChannelBenchmarks: Record<string, ChannelBenchmark> = {
  ...
  facebook: {
    ...
    ctrP25: 1.0,
    ctrP75: 2.3,
    source: "AppsFlyer/Adjust India app-install channel benchmarks — Facebook placements",
    tier: 3,
    confidenceScore: 57,
  },
  instagram: {
    ...
    ctrP25: 1.5,
    ctrP75: 3.4,
    source: "AppsFlyer/Adjust India app-install channel benchmarks — Instagram placements",
    tier: 3,
    confidenceScore: 56,
  },
  "google-uac": {
